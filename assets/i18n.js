...
window.ANTISHIMON_I18N = {
  ...
  en: {
    ...
    ui: {
      ...
      "מה בדיוק נכנס למרשם?": "What exactly gets into the registry?",
      "התקן, תוך כדי גלילה": "The standard, as you scroll",
      "התקן המלא": "The full standard",
      "עמדה שהוכרזה בעצמה": "Self-declared position",
      "ממצא רשמי": "Official finding",
      "שמועה": "Rumor",
      "ציטוט בלי תמליל": "Quote with no transcript",
      "פרשנות פרשן": "Pundit's interpretation",
      "ביקורת מדיניות בלבד": "Policy criticism alone",
      "נוספו החודש": "Added this month",
      "לא הצהרת כוונות — המרשם הזה מתעדכן כל יום, לא נבנה פעם אחת ונשכח.": "Not a statement of intent — this registry is updated daily, not built once and forgotten.",
      "עמדה שהוכרזה בעצמה.": "A self-declared position.",
      "הצבעת חברים, החלטת דירקטוריון, הודעה רשמית של הגוף.": "A membership vote, a board decision, an official statement from the body.",
      "או ממצא רשמי.": "Or an official finding.",
      "פסק דין, קנס רגולטורי, הודעת הפרה של רשות ממשלתית.": "A court ruling, a regulatory fine, a government violation notice.",
      "עמדה שהוכרזה בעצמה — נכנס": "Self-declared position — counts",
      "ממצא רשמי — נכנס": "Official finding — counts",
      "לא הצהרת כוונות:": "Not a statement of intent:",
      "גופים במרשם": "bodies in the registry",
      "מ־": "from ",
      "מדינות": "countries",
      "מגובים ב־": "backed by ",
      "מקורות עצמאיים": "independent sources",
      "נוספו בחודש האחרון בלבד — המרשם הזה מתעדכן, לא נבנה פעם אחת ונשכח.": "were added in the last month alone — this registry is maintained, not built once and forgotten.",
      "בתוך רשומה אחת": "Inside a single record",
      "כל רשומה נושאת שלושה דברים בו־זמנית: כמה חמור הנטען, כמה מקורות פתוחים מגבים אותו, ומי בדיוק עשה את המעשה. השדה השלישי הוא זה שהכי קל לפספס: מנכ״ל שהתבטא אינו החלטה של החברה — אחרת אנשים זורקים מוצר בגלל ציוץ של אדם אחד.": "Every record carries three things at once: how severe the claim is, how many open sources back it, and who exactly did it. The third field is the one it is easiest to miss: a CEO who spoke is not a decision by the company — otherwise people boycott a product over one person's tweet.",
      "סכימה להמחשה — לא רשומה אמיתית": "Illustrative schema — not a real record",
      "חומרה": "Severity",
      "3 פתוחים": "3 open",
      "מי עשה": "Who did it",
      "החלטת הגוף": "The body's decision",
      "״דברי הנהלה״ מסומן בנפרד מ״החלטת הגוף״ — הבחנה שהמרשם אוכף בכל רשומה.": "\"Executive remarks\" is marked separately from \"the body's decision\" — a distinction the registry enforces on every record.",
      "ומה לא נכנס — באותה בולטות": "And what does not get in — just as prominently",
      "שמועה או ״לפי מקורות״": "A rumor or \"according to sources\"",
      "— לא נכנס.": "— does not count.",
      "שמועה — לא נכנס": "Rumor — does not count",
      "ציטוט בלי תמליל או הקלטה": "A quote with no transcript or recording",
      "ציטוט בלי תמליל — לא נכנס": "Quote with no transcript — does not count",
      "פרשנות של פרשן, לא עובדה": "A pundit's interpretation, not a fact",
      "פרשנות פרשן — לא נכנס": "Pundit's interpretation — does not count",
      "ביקורת על מדיניות ישראל בלבד": "Criticism of Israeli policy alone",
      "זו אינה אנטישמיות, וסולם החומרה מפריד ביניהן במפורש.": "That is not antisemitism, and the severity scale separates the two explicitly.",
      "ביקורת מדיניות בלבד — לא נכנס": "Policy criticism alone — does not count",
